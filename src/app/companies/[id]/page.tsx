    ...
    <div className="space-y-8">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">{company.marketSegment} - {company.stage}</p>
        </div>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="p-4">
          <div className="space-y-2">
            ...
            <p className="text-2xl font-bold">${(company.totalFunding / 1000000).toFixed(1)}M</p>
          </div>
        </Card>
        <Card className="p-4">
          <div className="space-y-2">
            <p className="text-sm text-muted-foreground">Current Revenue</p>
            <p className="text-2xl font-bold">${(company.currentRevenue / 1000000).toFixed(1)}M ARR</p>
          </div>
        </Card>
        <Card className="p-4">
          <div className="space-y-2">
            <p className="text-sm text-muted-foreground">Growth Rate</p>
            <p className={`text-2xl font-bold ${company.revenueGrowth && company.revenueGrowth > 0 ? 'text-green-500' : ''}`}>
